        ...
        return {
            ...
            contents: [ {
...

                {
                    ...
                    elements: [ {
                        type: 'html',
                        html:   '<div class="find-replace-help-text">' +
                                '<p style="white-space: normal;">Here is the overview of all elements in the find/replace dialog:</p>' +
                                '<ul>' +
                                    '<li style="white-space: normal;"><strong>Find what</strong> - is the text field where you enter the word or phrase that you want to find.</li>' +
                                    '<li>' +
                                        '<p style="white-space: normal;"><strong>Match case</strong> - checking this option limits the search operation to words whose case matches the spelling (uppercase and lowercase letters) given in the search field. This means that the search becomes case-sensitive.</p>' +
                                        '<p style="white-space: normal;"><em>Example</em> - When Match case is checked and the search term is: "option", you will find all instances of "option" with this exact spelling but not when the word is spelled "Option" or "OPTION".</p>' +
                                    '</li>' +
                                    '<li>' +
                                        '<p style="white-space: normal;"><strong>Match whole word</strong> - checking this option limits the search operation to whole words.</p>' +
                                        '<p style="white-space: normal;"><em>Example</em> - When Match whole word is checked and the search term is: "option", you will find all instances of "option", but not the words "optional" or "options".</p>' +
                                    '</li>' +
                                    '<li>' +
                                        '<p"><strong>Match from start of text</strong> - checking this option means that after CKEditor reaches the end of the document, the search continues from the beginning of the text. This option is checked by default.</p>' +
                                        '<p style="white-space: normal;"><em>Example</em> - When Match whole word is checked and the search term is: "option", you will find all instances of "option", but not the words "optional" or "options".</p>' +
                                    '</li>' +
                                '</ul>' +
                                '<p style="white-space: normal;">After you enter the search term and select the options, press the Find button and CKEditor will highlight the first occurrence of the term in the text, starting from the current position of the cursor in text and going down. If you want to jump to the next occurrence of the term in the text, press the Find button again.</p>' +
                                '</div>'
                    } ]
                }],
            onLoad: function() {
